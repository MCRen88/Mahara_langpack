...
$string ['allowannotationfeedback'] = 'Дозволити зворотний зв"язок';
$string ['approvalrequired'] = 'Зворотній зв"язок модерується. Якщо ви вирішите зробити цей відгук публічним, він не буде видимим для інших, доки його не буде схвалено власником. ';

$string ['canteditnotauthor'] = 'Ви не є автором цього відгуку.';
$string ['annotationfeedbacknotinview'] = 'Відгук %d не на сторінці %d.';
$string ['cantedittooold'] = 'Ви можете редагувати лише зворотний зв"язок, який не перевищує %d хвилин.';
...
$string ['annotationfeedbackdeletedauthornotification'] = "Ваш відгук про %s було видалено: n %s";
...
$string ['annotationempty'] = 'Це поле обов"язкове.';
...
<p> <a href=\t%%"> Відповісти на цей відгук онлайн </a> </p>
</div> ';
...
$string ['artefactdefaultpermissionsdescription'] = 'Вибрані типи артефактів матимуть зворотний зв"язок при створенні. Користувачі можуть змінити ці налаштування для окремих артефактів. ';

$string ['annotationinformationerror'] = 'У нас немає потрібної інформації для відображення анотації.';

$string ['invalidannotationfeedbacklinkerror'] = 'Зворотній зв"язок має бути пов"язаний з артефактом або сторінкою.';
...
$string ['progress_annotation'] = array(
	...
	"Додати анотації %s до сторінок",
);
$string ['progress_annotationfeedback'] = array(
	"Надіслати 1 відгук до анотації іншого користувача",
	"Надіслати відгуки %s до анотацій інших користувачів",
);
$string ['duplicatedannotation'] = 'Дубльована анотація';
