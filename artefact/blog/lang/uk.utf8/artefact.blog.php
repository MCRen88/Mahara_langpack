...
$string ['pluginname'] = 'Журнали';
$string ['Blog'] = 'Журнал';
$string ['Blogs'] = 'Журнали';
$string ['blog'] = 'журнал';
$string ['blogs'] = 'журнали';
$string ['siteblogs'] = 'Журнали сайту';
$string ['siteblogsdesc'] = 'Створення та адміністрування журналів сайту';
$string ['institutionblogs'] = 'Журнали установ';
$string ['institutionblogsdesc'] = 'Створення та адміністрування журналів установ';
...
$string ['attach'] = 'Вкласти';
$string ['attachfilelistloaded'] = 'Завантажений список завантажених файлів';
$string ['attachfiles'] = 'Прикріплені файли';
...
$string ['blogpostdoesnotexist'] = 'Ви намагаєтеся отримати доступ до запису журналу, який не існує';
$string ['blogpost'] = 'Запис журналу';
$string ['blogdeleted'] = 'Журнал видалено';
$string ['blogpostdeleted'] = 'Запис журналу видалено';
$string ['blogpostpublished'] = 'Публікація журналу';
$string ['blogpostunpublished'] = 'Неопублікована запис журналу';
$string ['blogpostsaved'] = 'Запис журналу збережений';
$string ['blogsettings'] = 'Параметри журналу';
$string ['blogtitle'] = 'Заголовок';
...
$string ['deletebloghaspost?'] = array(
    ...
    1 => 'Цей журнал містить % d записів. Дійсно видалити цей журнал? ',
);
...
$string ['editblogpost'] = 'Редагувати запис журналу';
$string ['entriesimportedfromleapexport'] = 'Записи, імпортовані з експорту Leap2A, які не могли бути імпортовані в іншому місці';
$string ['errorsavingattachments'] = 'Сталася помилка під час збереження вкладень запису журналу';
$string ['horizontalspace'] = 'Горизонтальний простір';
$string ['insert'] = 'Вставити';
$string ['insertimage'] = 'Вставити зображення';
$string ['moreoptions'] = 'Додаткові параметри';
$string ['mustspecifytitle'] = 'Ви повинні вказати назву для запису';
$string ['mustspecifycontent'] = 'Ви повинні вказати певний вміст для вашого запису';
$string ['name'] = 'Ім"я';
...
$string ['noimageshavebeenattachedtothispost'] = 'До цього запису не було додано жодного зображення. Вам потрібно завантажити або додати зображення до запису, перш ніж його можна вставити. ';
$string ['nofilesattachedtothispost'] = 'Немає вкладених файлів';
$string ['noresults'] = 'Не знайдено записів журналу';
$string ['olderposts'] = 'Старіші записи' ;
$string ['post'] = 'запис';
$string ['postbody'] = 'Запис';
$string ['postbodydesc'] = '';
...
$string ['saveandpublish'] = 'Зберегти та опублікувати';
$string ['saveasdraft'] = 'Зберегти як чернетку';
$string ['savepost'] = 'Зберегти запис';
$string ['savesettings'] = 'Зберегти налаштування';
$string ['settings'] = 'Налаштування';
$string ['taggedposts'] = 'Повідомлення з тегами';
$string ['thisisdraft'] = 'Це запис';
$string ['thisisdraftdesc'] = 'Коли ваш запис - це проект, ніхто, крім вас, не бачить його.';
...
$string ['top'] = 'Верх';
$string ['middle'] = 'Середній';
$string ['bottom'] = 'Нижній';
$string ['texttop'] = 'Текст зверху';
$string ['textbottom'] = 'Нижній текст';
$string ['left'] = 'Ліворуч';
$string ['right'] = 'Право';
...
$string ['youhavenoinstitutionblogs1'] = 'У цій установі немає журналів. <a href="%s"> Додати один </a>. ';
...
$string ['shortcutaddpost'] = 'Додати новий запис до';
$string ['shortcutadd'] = 'Додати';
$string ['shortcutnewentry'] = 'Новий запис';
$string ['duplicatedblog'] = 'Дубльований журнал';
$string ['existingblogs'] = 'Існуючі журнали';
$string ['duplicatedpost'] = 'Дубльований запис журналу';
$string ['existingposts'] = 'Існуючі записи журналу';
