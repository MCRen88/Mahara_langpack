...
$string ['confirmdeletenote'] = 'Ця нотатка використовується у %d блоках і %d сторінках. Якщо ви вилучите його, всі блоки, які зараз містять текст, з\'являться порожніми. ';
$string ['noteeleted'] = 'Нотатка видалена';
$string ['noteupdated'] = 'Нотатка оновлена';
$string ['html'] = 'Нотатка';
