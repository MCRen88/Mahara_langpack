...
$string ['pluginname'] = 'Оцінка однолітків';
$string ['Assessment'] = 'Оцінка';
$string ['Evaluation'] = 'Оцінки';
$string ['assessment'] = 'оцінка';
$string ['ratings'] = 'оцінки';
$string ['makeassessmentpublic'] = 'Опублікувати оцінку';
$string ['attachfile'] = 'Вкласти файл';
$string ['messageempty'] = 'Оцінка однолітків порожня';
$string ['assessmentsubmitted'] = 'Оцінка однолітків збережена';
$string ['evaluationmentsubmitteddraft'] = 'Оцінка однолітків, збережена як чернетка';
$string ['reallydeletethisassessment'] = 'Видалити цю оцінку';
$string ['thisassessmentisprivate'] = 'Збережено як чернетку';
