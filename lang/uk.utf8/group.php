...
$string ['associatewithinstitution'] = 'Зв’язатися з установою';
$string ['associatewithaninstitution'] = 'Приєднати групу %s до установи.';
$string ['groupassociated'] = 'Група успішно пов"язана з установою';
...
$string ['controlleddescription'] = 'Адміністратори групи можуть додавати користувачів до групи без їхньої згоди, і учасники не можуть залишити групу.';
...
$string ['requestmembership'] = 'Запитувати членство';
...
$string ['groupshortnamealreadyexists'] = 'Група з цим коротким ім"ям вже існує.';
$string ['invalidshortname'] = 'Недійсне коротке ім"я групи.';
...
$string ['editwindowbetween'] = 'Між %s і %s';
$string ['editwindowfrom'] = 'Від %s';
$string ['editwindowuntil'] = 'До тих пір, поки %s';
$string ['groupadmins'] = 'Адміністратори групи';
$string ['editroles1'] = 'Створення та редагування';
...
$string ['publiclyviewablegroup'] = 'Група загальнодоступних для перегляду';
...
$string ['viewnotify'] = 'Повідомлення зі спільними сторінками';
$string ['viewnotifydescription2'] = 'Вибір членів групи, які повинні отримувати сповіщення, коли створюється нова сторінка групи, і коли учасник групи надсилає одну зі своїх сторінок до групи. Член групи, який поділився цією сторінкою, не отримає цього сповіщення. Для дуже великих груп краще обмежити їх не звичайними членами, оскільки це може зробити багато повідомлень. ';
$string ['commentnotify'] = 'Повідомлення коментарів';
$string ['commentnotifydescription1'] = 'Вибір членів групи, які повинні отримувати повідомлення, коли коментарі розміщуються на сторінці групи та артефакти.';
$string ['letsendnow'] = 'Відразу надсилати повідомлення на форумі';
$string ['letsendnowdescription1'] = 'Будь-який учасник групи може відразу відправити повідомлення на форумі. Якщо для цього параметра встановлено значення "Вимкнено", це можуть зробити лише адміністратори групи, репетитори та модератори. ';
...
$string ['hidemembersfrommembersdescription1'] = 'Приховати членів цієї групи. Список членів може бачити лише адміністратори групи. Адміністратори все ще відображаються на домашній сторінці групи. ';
$string ['friendinvitations'] = 'Друзі запрошення';
$string ['invitefriendsdescription1'] = 'Дозволити учасникам запрошувати друзів приєднатися до цієї групи. Незалежно від цього налаштування адміністратори групи можуть завжди надсилати запрошення кожному. ';
...
$string ['editgroupmembership'] = 'Редагувати групове членство';
...
$string ['addedtongroupsmessage'] = array(
    0 => '"%2" додав вас до групи: n n 3 %s \ t',
...
$string ['releaseview'] = 'Сторінка релізу';
$string ['releasecollection'] = 'Випуск колекції';
...
$string ['viewreleasedsubject1'] = 'Ваша сторінка "%s" була випущена з групи "%s" %s';
$string ['viewreleasedmessage1'] = 'Ваша сторінка "%s" була випущена з групи "%s" %s';
$string ['collectionreleasedsubject1'] = 'Ваша колекція "%s" була випущена з групи "%s" %s';
$string ['collectionreleasedmessage1'] = 'Ваша колекція "%s" була випущена з групи "%s" %s';
$string ['viewreleasedsuccess'] = 'Сторінка була успішно випущена';
$string ['viewreleasedpending'] = 'Сторінка буде випущена після архівування';
$string ['collectionreleasedsuccess'] = 'Колекція була успішно випущена';
$string ['collectionreleasedpending '] =' Колекція буде випущена після архівування ';
...
$string ['joingroup'] = 'Ви тепер є членом групи.';
...
$string ['grouprequestmessagereason'] = '%s хотіли б приєднатися до вашої групи %s';
$string ['cantdeletegroup'] = 'Ви не можете видалити цю групу.';
$string ['groupconfirmdelete'] = 'Це призведе до видалення всіх сторінок, файлів і форумів, що містяться в групі. Ви впевнені, що бажаєте повністю видалити цю групу і весь її вміст?';
$string ['deletegroup'] = 'Група успішно видалена';
$string ['deletegroup1'] = 'Видалити групу';
$string ['allmygroups'] = 'Усі мої групи';
$string ['groupsimin'] = 'Групи, в яких я';
$string ['groupsiown'] = 'Групи, якими я володію';
$string ['groupsiminvitedto'] = 'Групи, до яких я запрошений';
$string ['groupsiwanttojoin'] = 'Групи, яким я хочу приєднатися';
...
$string ['memberslist'] = 'Користувачі:';
$string ['nogroups'] = 'Немає груп';
$string ['deletespecifiedgroup'] = 'Видалити групу \ _ "%s" \ _';
$string ['requestjoinspecifiedgroup'] = 'Запит на приєднання до групи \ _ "%s" \ _';
$string ['youaregroupmember'] = 'Ви є членом цієї групи.';
$string ['youaregroupadmin'] = 'Ви адміністратор цієї групи.';
$string ['youowngroup'] = 'Ви володієте цією групою.';
$string ['groupsnotin'] = 'Не мої групии';
$string ['allgroups'] = 'Усі групи';
$string ['allgroupmembers'] = 'Всі учасники групи';
$string ['trysearchingforgroups'] = 'Спробуйте %s searching для груп %s, щоб приєднатися.';
...
$string ['hideonlygrouptutors'] = 'Приховати вихователів';

// Масове додавання, запрошення
$string ['addmembers'] = 'Додати учасників';
$string ['invitationssent'] = 'відправлено запрошення %d';
$string ['newmembersadded'] = 'Додано %d нових учасників';
$string ['potentialmembers'] = 'Потенційні члени';
$string ['sendinvitations'] = 'Надіслати запрошення';
$string ['userstobeadded'] = 'Користувачів для додавання';
...
$string ['friendformrequestsuccess'] = 'Надіслано запит дружби %s';
$string ['friendformacceptsuccess'] = 'Запит на дружбу';
$string ['friendformrejectsuccess'] = 'Відхилений запит на дружбу';

$string ['addtofriendslist'] = 'Додати до друзів';
$string ['requestfriendship'] = 'Запитувати дружбу';

$string ['addedtofriendslistsubject'] = '%s додав вас до друзів';
$string ['addedtofriendslistmessage'] = '%s додав вас до друзів. Це означає, що тепер %s є у вашому списку друзів. Натисніть на посилання нижче, щоб переглянути сторінку профілю';

$string ['requestedfriendlistsubject'] = 'Запит нового друга';
$string ['requestedfriendlistinboxmessage'] = '%s запросив додати його як друга, Ви можете зробити це, натиснувши наступне посилання або перейшовши на сторінку списку друзів ';

$string ['requestedfriendlistmessageexplanation'] = '%s запросив додати його як друга. Ви можете зробити це, натиснувши на наступне посилання або перейшовши на сторінку списку друзів 
    Його причина:
    ';

$string ['removefromfriendslist'] = 'Видалити з друзів';
...
$string ['pendingfriends'] = 'Очікують на додання у список друзів';
...
$string ['whymakemeyourfriend'] = 'Тому ви повинні зробити мене своїм другом:';
...
$string ['trysearchingforfriends'] = 'Спробуйте %s searching для нових друзів %s, щоб збільшити вашу мережу.';
...
$string ['existingfriend'] = 'існуючий друг';
...
$string ['Friends'] = 'Друзі';
$string ['Everyone'] = 'Усі';
$string ['myinstitutions'] = 'Мої установи';
...
$string ['denyfriendrequest'] = 'Заперечити запит на дружбу';
$string ['sendfriendshiprequest'] = 'Надіслати запит про дружбу %s';
...
$string ['requestedfriendship'] = 'запитана дружба';
...
$string ['denyfriendrequestlower'] = 'Заперечити запит на дружбу';

// Групові взаємодії (дії)
$string ['groupinteractions'] = 'Групова діяльність';
$string ['nointeractions'] = 'У цій групі немає жодних дій.';
$string ['notallowedtoeditinteractions'] = 'Вам не дозволено додавати або редагувати діяльність у цій групі.';
$string ['notallowedtodeleteinteractions'] = 'Вам не дозволяється видаляти дії в цій групі.';
$string ['interactionsaved'] = '%s успішно збережено';
$string ['deleteinteraction'] = 'Видалити %s \ t';
$string ['deleteinteractionsure'] = 'Ви впевнені, що хочете це зробити? Її не можна скасувати. ';
...
$string ['rolechanged'] = 'Змінено роль';
$string ['removefromgroup'] = 'Видалити з групи';
$string ['userremoved'] = 'Користувач видалений';
$string ['About'] = 'Про програму';
$string ['aboutgroup'] = 'Про %s';
$string ['Joined'] = 'Зареєстровано';
$string ['invitemembersdescription'] = 'Можна запросити користувачів приєднатися до цієї групи на своїх сторінках профілю або <a href="%s"> відправити декілька запрошень одразу </a>.';
$string ['membersdescription: controlled'] = 'Це контрольована група членства. Ви можете додати користувачів безпосередньо через їхні сторінки профілю або <a href="%s"> додати багато користувачів одночасно </a>. ';

// Переглянути подання
$string ['submit'] = 'Надіслати';
$string ['allowssubmissions'] = 'Дозволяє подання';
$string ['letsubmissions'] = 'Дозволити подання';
$string ['allowssubmissionsdescription1'] = 'Учасники можуть надсилати сторінки до групи, які попередньо будуть заблоковані. Ці сторінки не можна редагувати, доки їх не буде видано наставником або адміністратором групи.';
$string ['allowssubmissionsdescription'] = 'Користувачі можуть надсилати сторінки до групи.';
$string ['letsarchives'] = 'Дозволити архівування подань';
$string ['letsarchivesdescription'] = 'Сторінки / колекції архівуються як архівовані файли Leap2A під час процесу випуску реєстрації.';

// Групові звіти
$string ['report'] = 'Повідомити';
...
$string ['membercommenters'] = 'Участь учасників';
$string ['extcommenters'] = 'Залучені не-члени';
$string ['groupparticipationreports'] = 'Звіт про участь';
$string ['groupparticipationreportsdesc1'] = 'Адміністратори групи можуть отримати доступ до звіту, що відображає всі групи та спільні сторінки, і хто коментує їх';
